...
CNI_BRIDGE_SCRIPT_RAW_URL="https://raw.githubusercontent.com/chalk-hwang/unifios-utilities/main/on-boot-script-2.x/examples/udm-networking/on_boot.d/06-cni-bridge.sh"
